    ...
    <section className="mx-auto mt-16 w-full max-w-[1200px] px-4 sm:mt-20 sm:px-6">
      ...
      >
        <motion.div className="absolute inset-0" style={{ y: imageY }} aria-hidden>
          <Image src={internetPhoto} alt="" fill priority className="object-cover object-[65%_center]" sizes="1200px" />
        </motion.div>
        <div className="absolute inset-0 bg-[linear-gradient(90deg,#0b2522_0%,rgba(11,37,34,0.92)_28%,rgba(11,37,34,0.46)_58%,rgba(11,37,34,0.18)_100%)]" />
